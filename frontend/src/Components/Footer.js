    ...
    return (
        <div className='footer'>
            <div>
                <div className='footer-data'>
                    <div className="contact-details">
                        ...
                        <p>Mahrashtra</p>
                        <p>India</p>
                        <p><b>Email:</b>gauravjichkar14@gmail.com</p>
                    </div>
            ...
            <div className='copyright-details'>
                <p className='footer-copyright'>&#169; 2024 copyright all right reserved<br /><span>Designed with ❤️ by Gaurav Jichkar</span></p>
            </div>
        </div>
    )
}
